    ...
    <section className="py-24 bg-background border-b border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeInStagger className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          {/* Step 1 */}
          <FadeIn>
            <div className="flex flex-col items-center text-center bg-background group cursor-pointer">
               <div className="w-16 h-16 bg-surface border border-border rounded-lg shadow-hard flex items-center justify-center mb-6 z-10 hover-lift">
                <span className="font-mono text-xl font-bold group-hover:text-accent transition-colors">1</span>
              </div>
          ...
          <FadeIn>
            <div className="flex flex-col items-center text-center bg-background group cursor-pointer">
              <div className="w-16 h-16 bg-surface border border-border rounded-lg shadow-hard flex items-center justify-center mb-6 z-10 hover-lift">
                <span className="font-mono text-xl font-bold group-hover:text-accent transition-colors">2</span>
              </div>
               <h3 className="text-xl font-bold text-ink-primary mb-4 flex items-center gap-2">
          ...
          <FadeIn>
            <div className="flex flex-col items-center text-center bg-background group cursor-pointer">
               <div className="w-16 h-16 bg-surface border border-border rounded-lg shadow-hard flex items-center justify-center mb-6 z-10 hover-lift">
                <span className="font-mono text-xl font-bold group-hover:text-accent transition-colors">3</span>
              </div>
               <h3 className="text-xl font-bold text-ink-primary mb-4 flex items-center gap-2">
