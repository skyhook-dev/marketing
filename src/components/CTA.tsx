    ...
    <section className="py-24 bg-background">
      <div className="w-[1310px] mx-auto">
        <FadeIn>
          ...
          >
            <h2 className="text-[50px] font-semibold text-white text-center leading-[120%] mb-6">
              Ready to roll?
            </h2>
            <p className="text-[18px] font-normal text-white/90 text-center leading-normal mb-10">
