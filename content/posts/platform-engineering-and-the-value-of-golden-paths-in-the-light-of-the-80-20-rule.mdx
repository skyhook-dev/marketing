---
title: "Platform Engineering & The Value of Golden Paths in the Light of the 80-20 Rule"
date: December 2024
author: Roy Libman, CPO
category: Platform Engineering
tags: [explainer, golden-paths, platform-engineering, for-platform-engineers]
readTime: 4 min read
image: /images/blog/golden-paths.webp
---

Explore how Platform Engineering and Golden Paths streamline software development by offering guided solutions for 80% of tasks, while leaving room for innovation in the remaining 20%. Enhance productivity without restricting creativity.

In the ever-evolving realm of software development, stepping into a new role can be both thrilling and intimidating. For example, a Java developer joining a new company might find themselves not just coding in Java but navigating the complex world of DevOps, tackling operational codes, building pipelines, monitoring systems, and perhaps an entirely new cloud platform. The tasks ahead may seem overwhelming.
